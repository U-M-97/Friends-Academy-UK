...
const Contact = () => {
  ...
  return (
    <div
      className="pb-20 flex font-main items-center justify-center bg-servicesBG "
      id="contact"
    >
      <div className="w-full sm:w-width flex flex-col sm:flex-row">
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-10 flex ">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="h-14 w-14 border border-lightGray rounded-full flex items-center justify-center sm:ml-4 text-green hover:text-white cursor-pointer hover:bg-green duration-300"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className=" h-14 w-14 border border-lightGray rounded-full flex items-center justify-center ml-2 sm:ml-4 text-green hover:text-white cursor-pointer hover:bg-green duration-300"
              >
        ...
        <div className="flex-1 flex flex-col sm:mr-40 mx-10 sm:mx-0">
          ...
          <div>
            <p className="text-lg mt-10 sm:mt-12">
              If you have any questions or just want to get in touch, use the
              form below. We look forward to hearing from you! You can get in
              touch with us directly at{" "}
              <a className="text-green underline">team@friendsacademy.co.uk.</a>
            </p>
            <input
              className="p-2 w-full border border-green rounded-sm mt-5 text-lg outline-black"
              name="name"
              value={inputs.name}
              placeholder="Name"
            ...
            />
            <textarea
              className="p-2 pb-20 w-full border border-green rounded-sm mt-5 text-lg outline-black"
              name="message"
            ...
            <button
              className="w-full bg-pink mt-5 p-4 rounded-md text-white font-bold hover:bg-green duration-300"
              onClick={handleEmail}
            >
              Send Message
            </button>

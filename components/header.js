        ...
        <div className="flex mt-2 flex-col w-screen sm:mt-0 sm:flex-row sm:w-width sm:justify-between">
          <div className="px-3 sm:p-0 sm:flex justify-between sm:ml-32 items-center">
            <div className="flex cursor-pointer">
              ...
              <address className="text-font not-italic hover:text-green duration-200">
                +44 7532 707561
              </address>
              <address className="text-font not-italic hover:text-green duration-200 ml-2">
                +44 7449 347301
              </address>
            </div>
          ...
          <div className="flex justify-center mt-2 sm:mr-40 sm:mt-0 items-center">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="hover:text-green duration-300 cursor-pointer mr-4"
            >
              <WhatsAppIcon />
            </a>
            <a
            ...
            {user == null ? (
              <div className="mx-4 cursor-pointer">
                <Link href="/account/login">
                  <button className="py-2 px-4 bg-green rounded-md font-bold hover:bg-pink duration-300 hover:text-white">
                    LOGIN
                  </button>
                </Link>
              </div>

        ...
        >
          <div className="sm:h-card sm:w-card rounded-xl p-8 mx-5 hover:bg-green hover:text-white duration-200 group">
            ...
            <p className="mt-4 text-lg">
              Pay only once and attend the course as many times as you want till
              you pass.
            </p>
          </div>
          <div className=" sm:h-card sm:w-card rounded-xl p-8 mx-5 hover:bg-green hover:text-white duration-200 group">
            <PeopleIcon className=" scale-services ml-5 mt-6 text-green group-hover:text-white" />
            <h1 className="mt-11 text-2xl font-bold">
              Interactive PLAB 2 Practice Sessions
            </h1>
            <p className="mt-4 text-lg">
              Rather than whiteboard teaching we offer live (simulated) patient
              doctor roleplay
            </p>
          </div>
          <div className=" sm:h-card sm:w-card rounded-xl p-8 mx-5 hover:bg-green hover:text-white duration-200 group">
            ...
            <p className="mt-4 text-lg">
              We shall help you to choose the career in UK according to your
              desires.
            </p>
          </div>
        </motion.div>
      ...
      <div ref={card2} className="sm:mt-10">
        ...
        >
          <div className="sm:h-card sm:w-card rounded-xl p-8 mx-5 hover:bg-green hover:text-white duration-200 group">
            ...
            <h1 className="mt-11 text-2xl font-bold">
              Support with CV Building
            </h1>
            <p className="mt-4 text-lg">
              We shall guide you to write a professional CV to help secure a
              job.
            </p>
          </div>
          <div className="sm:h-card sm:w-card rounded-xl p-8 mx-5 hover:bg-green hover:text-white duration-200 group">
            ...
            <p className="mt-4 text-lg">
              We shall help and guide you to hunt the appropriate first job to
              start your career in UK.
            </p>
          </div>
          <div className="sm:h-card sm:w-card rounded-xl p-8 mx-5 hover:bg-green hover:text-white duration-200 group">
            ...
            <p className="mt-4 text-lg">
              We shall prepare you for the successful interview.
            </p>
          </div>
        </motion.div>
      </div>
      ...
      <div ref={card3} className="sm:mt-10 mb-10">
        ...
        >
          <div className="sm:h-card sm:w-card rounded-xl p-8 mx-5 hover:bg-green hover:text-white duration-200 group">
            ...
            <h1 className="mt-11 text-2xl font-bold">
              Online and Onsite PLAB 2 Courses
            </h1>
            <p className="mt-4 text-lg">
              There is a course every month and you can join online or onsite

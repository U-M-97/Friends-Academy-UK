  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: (params) => {
        ...
        return (
          <button
            className="bg-green py-2 px-5 rounded-sm hover:bg-greenHover"
      ...
      <FullLayout>
        <div className="font-main">
          <div className="flex items-center justify-center">
            <button
              className="mb-5 bg-green rounded-md py-2 px-4 text-lg font-bold hover:bg-greenHover hover:text-white"
              onClick={handleOpen}
            >
              Add New Room
            </button>

...
const UpdateCourses = () => {
      ...
      courses.map((course) => {
        ...
        if (course.category === selectedCategory) {
          return arr.push({
            ...
            courseStartDate: dayjs(course.startDate).format("DD MMMM, YYYY"),
            courseEndDate: dayjs(course.endDate).format("DD MMMM, YYYY"),
          });
        }
      });
    setRows(arr);
    ...
    { field: "courseEndDate", headerName: "End Date", width: 160 },
    {
      ...
      renderCell: (params) => {
        ...
        return (
          <>
            <button
              className="py-2 px-5 bg-green rounded-sm hover:bg-greenHover"
  ...
  useEffect(() => {
    const handleKey = (e) => {
      ...
      (link && link.contains(e.target)) || (link2 && link2.contains(e.target))
        ? null
        : setCalendar(false) || setCalendar2(false);
    };
                  ...
                  {inputs && apiRes == false ? (
                    <div className="flex flex-col items-center justify-center">
                      <div className="flex relative items-center">
                        ...
                        <label
                          for="file"
                          className="ml-4 cursor-pointer bg-dashboard px-5 py-2 left-36 top-6 text-md hover:bg-green rounded-md"
                        >
                          Change Image
                        </label>
                        <input
                      ...
                      <div className="mt-4 relative">
                        ...
                        <input
                          ...
                          className=" w-96 mt-10 border border-black py-4 px-3 rounded-md "
                        ...
                        <input
                          ...
                          onClick={() => setCalendar2(true)}
                        />
                        {calendar && (
                          <div
                            className="z-10 absolute bottom-40"
                            id="calendar"
                          >
                            <Calendar
                        ...
                        {calendar2 && (
                          ...
                          >
                            <Calendar
                              className=" bg-white border-2"
                              onChange={setEndDateValueCalendar}
                              value={endDateValueCalendar}
                            />
                          </div>
                        )}
                      </div>

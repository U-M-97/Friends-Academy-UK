...
const Signup = () => {
    ...
    const handleSubmit = async () => {
        try{
            const res = await axios.post("http://localhost:3000/api", inputs)
            console.log(res)
        }catch(err){
            console.log(err)
        }
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-lightGray font-main">
        <div className="flex h-slider w-aboutWidth shadow-lg shadow-gray rounded-2xl">
            ...
            <div className="flex-1 flex flex-col items-center bg-login justify-center">
                ...
                <div className="flex mt-10">
                     ...
                     <a className="ml-2 underline hover:text-green duration-300">

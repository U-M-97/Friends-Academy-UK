    ...
    <div className="flex items-center justify-center h-screen w-screen bg-lightGray font-main">
      <div className="flex h-slider w-aboutWidth shadow-lg shadow-gray rounded-2xl">
        ...
        <div className="flex-1 flex flex-col items-center bg-login justify-center rounded-r-2xl">
          ...
          <input
            placeholder="Email"
            className="p-3 w-96 rounded-sm outline-none hover:outline-pink focus:outline-pink mt-10"
            onChange={(e) =>
          ...
          />
          {isInputs === false ? (
            <Alert severity="error" className="mt-2 w-96">
          ...
          {invalidCredentials === true ? (
            <Alert
              ...
              severity="warning"
              className="mt-2 w-96 text-white"
            >
              Invalid Credentials!
            </Alert>
          ) : null}
          <button
            className="bg-green hover:bg-greenHover text-xl p-3 rounded-sm w-96 mt-5"
